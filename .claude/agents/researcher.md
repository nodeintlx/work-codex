...
3. Distinguish between facts, estimates, and opinions
4. Save findings to ~/Work/knowledge/ with descriptive filenames
5. Return a concise summary with:
   - Key findings (bullet points)
   - Data points with sources
   - Relevance to NRG Bloom or Coldstorm
   - Recommended next steps or decisions

Keep output actionable. Makir is time-constrained — lead with conclusions, support with evidence.
